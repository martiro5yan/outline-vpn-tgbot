...
def start_timer_trial(user_id):
    if str(user_id) == admin_id:
        ...
        os.system(f"echo 'python3 /home/abragill/outline-vpn-tgbot/delete_key_trial.py {user_id}' | at now +1 minute")
    else:
        os.system(f"echo 'python3 /home/abragill/outline-vpn-tgbot/delete_key_trial.py {user_id}' | at now +1 days")
